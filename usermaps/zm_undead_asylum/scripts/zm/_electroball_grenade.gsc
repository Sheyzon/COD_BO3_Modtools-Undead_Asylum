...
function function_cb55123a()
{
	...
	while(true)
	{
		var_82aacc64 = zm_elemental_zombie::get_non_elemental_zombies();
		var_82aacc64 = arraysortclosest(var_82aacc64, self.origin);
		var_199ecc3a = zm_elemental_zombie::get_elemental_zombie_count("sparky");
			...
			if(!isdefined(level.var_a9284ac8) || (gettime() - level.var_a9284ac8) >= 0.5)
			{
				foreach(var_73487940, ai_zombie in var_82aacc64)
				{
					...
					if(dist_sq <= 9216 && ai_zombie.is_elemental_zombie !== 1 && ai_zombie.var_3531cf2b !== 1)
					{
						...
						ai_zombie zm_elemental_zombie::make_sparky_zombie();
