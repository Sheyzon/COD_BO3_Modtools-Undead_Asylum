...
DataSources.BuyablePerksDataSource = DataSourceHelpers.ListSetup("BuyablePerksDataSource", function(InstanceRef)
    ...
    AddPerkEntry("Quick Revive", quickReviveCost, "perk.quickrevive", "i_t7_specialty_quickrevive", "Drink to revive faster. Self-Revive on solo.")
    AddPerkEntry("Juggernog", 2500, "perk.armorvest", "i_t7_specialty_armorvest", "Drink to increase health.")
    AddPerkEntry("Double Tap 2.0", 2000, "perk.doubletap2", "i_t7_specialty_doubletap2", "Drink to shoot double firepower.")
    AddPerkEntry("Speed Cola", 3000, "perk.fastreload", "i_t7_specialty_fastreload", "Drink to reload faster.")
    AddPerkEntry("Stamin-Up", 2000, "perk.staminup", "i_t7_specialty_staminup", "Drink to run and sprint faster.")
    AddPerkEntry("Widows Wine", 4000, "perk.widowswine", "i_t7_specialty_widowswine", "Drink to gain Widow's Wine grenades.")
    AddPerkEntry("Electric Cherry", 2000, "perk.electriccherry", "i_t7_specialty_electriccherry", "Drink to sparkly sparkly gooo on reload!.")
    AddPerkEntry("Mule Kick", 4000, "perk.additionalprimaryweapon", "i_t7_specialty_additionalprimaryweapon", "Drink to carry an additional weapon.")
    AddPerkEntry("Deadshot Daiquiri", 1500, "perk.deadshot", "i_t7_specialty_deadshot", "Drink to improve aiming down sights.")
    AddPerkEntry("PHD Flopper", 2000, "perk.phdflopper", "i_t7_specialty_phdflopper", "Drink to negate any fall and explosive damage.")
    AddPerkEntry("Vulture Aid", 3000, "perk.vultureaid", "i_t7_specialty_vultureaid", "Drink to gather extra drops from zombies. Green gas will make you invisible for zombies.")
    AddPerkEntry("Whos Who", 2000, "perk.whoswho", "i_t7_specialty_whoswho", "Drink to respawn as player when killed. Revive yourself or simply run!")
